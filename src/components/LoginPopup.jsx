...
const LoginPopup = () => (
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70">
    <div className="bg-gray-900 rounded-2xl shadow-2xl p-8 w-full max-w-md flex flex-col items-center relative">
      <button className="absolute top-4 right-4 text-gray-400 hover:text-cyan-400 text-2xl font-bold focus:outline-none" id="closeLogin">&times;</button>
      ...
      <div className="mt-4 text-gray-400 text-sm">
        Don't have an account? <a href="#" className="text-cyan-400 hover:underline" id="openVerify">Verify Email</a>
      </div>
    </div>
  </div>
);
